import {
  require_classnames
} from "./chunk-UKNNGIRR.js";
import {
  require_jsx_runtime
} from "./chunk-HUZ3FQDY.js";
import {
  require_react_dom
} from "./chunk-LY7AAJIB.js";
import {
  require_react
} from "./chunk-OHBLVYYI.js";
import {
  __commonJS,
  __toESM
...
function $c7eafbbe1ea5834e$var$useCounter(isDisabled = false) {
  ...
  if (ref.current === null && !isDisabled) {
    let currentOwner = (0, import_react43.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED?.ReactCurrentOwner?.current;
    if (currentOwner) {
