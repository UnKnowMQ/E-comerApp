    ...
    !function(t3, e4, s3) {
      ...
      switch (e4[s3._const.action]) {
        ...
        case s3._const.modifySelected:
          ...
          break;
        case s3._const.replaceElement:
          l2 = O(e4[s3._const.newValue]), a2.childNodes[o2] = l2;
          break;
        case s3._const.relocateGroup:
        ...
        case s3._const.addElement:
          ...
          n2 = null === (i2 = k(t3, d2)) || void 0 === i2 ? void 0 : i2.node, l2 = O(e4[s3._const.element]), n2.childNodes || (n2.childNodes = []), u2 >= n2.childNodes.length ? n2.childNodes.push(l2) : n2.childNodes.splice(u2, 0, l2), n2.subsets && n2.subsets.forEach(function(t4) {
...
var Y = function() {
  ...
  return t2.prototype.init = function() {
    ...
    do {
      ...
      0 === (s2 = this.findNextDiff(t3, e2, [])).length && (x(t3, e2) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = true, N(t3), s2 = this.findNextDiff(t3, e2, [])))), s2.length > 0 && (this.foundAll = false, this.tracker.add(s2), S(t3, s2, this.options));
    } while (s2.length > 0);
    ...
    if (t3.nodeName !== e2.nodeName) {
      ...
      return [new f().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(t3)).setValue(this.options._const.newValue, O(e2)).setValue(this.options._const.route, s2)];
    }
    if (s2.length && this.options.diffcap < Math.abs((t3.childNodes || []).length - (e2.childNodes || []).length)) return [new f().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(t3)).setValue(this.options._const.newValue, O(e2)).setValue(this.options._const.route, s2)];
    ...
    for (var h2 = 0; h2 < a2; h2 += 1) {
      ...
      o2 && (u2 && !p2 ? "#text" === u2.nodeName ? (r2.push(new f().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s2.concat(l2)).setValue(this.options._const.value, u2.data)), l2 -= 1) : (r2.push(new f().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s2.concat(l2)).setValue(this.options._const.element, O(u2))), l2 -= 1) : p2 && !u2 && ("#text" === p2.nodeName ? r2.push(new f().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s2.concat(l2)).setValue(this.options._const.value, p2.data)) : r2.push(new f().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s2.concat(l2)).setValue(this.options._const.element, O(p2))))), u2 && p2 && (!this.options.maxChildCount || a2 < this.options.maxChildCount ? r2 = r2.concat(this.findNextDiff(u2, p2, s2.concat(l2))) : x(u2, p2) || (i2.length > n2.length ? ("#text" === u2.nodeName ? r2.push(new f().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s2.concat(l2)).setValue(this.options._const.value, u2.data)) : r2.push(new f().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, O(u2)).setValue(this.options._const.route, s2.concat(l2))), i2.splice(h2, 1), h2 -= 1, l2 -= 1, o2 -= 1) : i2.length < n2.length ? (r2 = r2.concat([new f().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, O(p2)).setValue(this.options._const.route, s2.concat(l2))]), i2.splice(h2, 0, O(p2)), o2 -= 1) : r2 = r2.concat([new f().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(u2)).setValue(this.options._const.newValue, O(p2)).setValue(this.options._const.route, s2.concat(l2))]))), l2 += 1;
    }
    ...
    for (var a2, o2, r2, l2, d2, c2 = function(t4, e3, s3) {
      ...
      else true === u2[v2] ? b2.push(new f().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(l2)).setValue(this.options._const.newValue, O(m2[v2])).setValue(this.options._const.route, i2.concat(_2))) : (b2.push(new f().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i2.concat(_2)).setValue(this.options._const.element, O(l2))), h2.splice(_2, 1), p2.splice(_2, 1), g2 = Math.min(h2.length, u2.length), _2 -= 1, v2 -= 1);
      else if (true === u2[v2]) "#text" === (l2 = m2[v2]).nodeName ? (b2.push(new f().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i2.concat(_2)).setValue(this.options._const.value, l2.data)), h2.splice(_2, 0, true), p2.splice(_2, 0, { nodeName: "#text", data: l2.data }), g2 = Math.min(h2.length, u2.length)) : (b2.push(new f().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i2.concat(_2)).setValue(this.options._const.element, O(l2))), h2.splice(_2, 0, true), p2.splice(_2, 0, O(l2)), g2 = Math.min(h2.length, u2.length));
      else if (h2[_2] !== u2[v2]) {
...
var W = z(U.exports = function() {
  ...
  var y2 = "$isDayjsObject", M2 = function(t3) {
    return t3 instanceof x2 || !(!t3 || !t3[y2]);
    ...
    return s3.date = t3, s3.args = arguments, new x2(s3);
  }, O2 = v2;
  O2.l = D2, O2.i = M2, O2.w = function(t3, e3) {
  ...
  var x2 = function() {
    ...
    return b3.parse = function(t3) {
      ...
      return O2.u(t3) ? this[e3] : this.set(s3, t3);
    }, b3.unix = function() {
      return Math.floor(this.valueOf() / 1e3);
    }, b3.valueOf = function() {
      return this.$d.getTime();
    }, b3.startOf = function(t3, e3) {
      var s3 = this, i3 = !!O2.u(e3) || e3, c3 = O2.p(t3), p3 = function(t4, e4) {
        var n3 = O2.w(s3.$u ? Date.UTC(s3.$y, e4, t4) : new Date(s3.$y, e4, t4), s3);
        return i3 ? n3 : n3.endOf(r2);
      }, f3 = function(t4, e4) {
        return O2.w(s3.toDate()[t4].apply(s3.toDate("s"), (i3 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e4)), s3);
      ...
      var s3, l3 = O2.p(t3), c3 = "set" + (this.$u ? "UTC" : ""), p3 = (s3 = {}, s3[r2] = c3 + "Date", s3[u2] = c3 + "Date", s3[d2] = c3 + "Month", s3[h2] = c3 + "FullYear", s3[o2] = c3 + "Hours", s3[a2] = c3 + "Minutes", s3[n2] = c3 + "Seconds", s3[i2] = c3 + "Milliseconds", s3)[l3], f3 = l3 === r2 ? this.$D + (e3 - this.$W) : e3;
      if (l3 === d2 || l3 === h2) {
      ...
      var u3, p3 = this;
      i3 = Number(i3);
      var f3 = O2.p(c3), m3 = function(t3) {
        var e3 = N2(p3);
        return O2.w(e3.date(e3.date() + Math.round(t3 * i3)), p3);
      };
      ...
      var i3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", n3 = O2.z(this), a3 = this.$H, o3 = this.$m, r3 = this.$M, l3 = s3.weekdays, d3 = s3.months, c3 = s3.meridiem, h3 = function(t4, s4, n4, a4) {
        return t4 && (t4[s4] || t4(e3, i3)) || n4[s4].slice(0, a4);
      }, u3 = function(t4) {
        return O2.s(a3 % 12 || 12, t4, "0");
      ...
      var f3, m3 = this, g4 = O2.p(u3), b4 = N2(i3), v3 = (b4.utcOffset() - this.utcOffset()) * e2, _3 = this - b4, w3 = function() {
        return O2.m(m3, b4);
      };
      switch (g4) {
        case h2:
  ...
  return N2.prototype = E2, [["$ms", i2], ["$s", n2], ["$m", a2], ["$H", o2], ["$W", r2], ["$M", d2], ["$y", h2], ["$D", u2]].forEach(function(t3) {
    ...
    return t3.$i || (t3(e3, x2, N2), t3.$i = true), N2;
...
var Z = (t2, e2) => {
  if (t2?.constructor === Object && Object.prototype.hasOwnProperty.call(t2, "data") && !Object.keys(t2).find((t3) => !["text", "order", "data", "attributes"].includes(t3))) return t2;
  const s2 = { data: t2 };
  switch (e2.type) {
    case "string":
...
var K = (t2, e2 = void 0, s2, n2, a2) => {
  ...
  if (t2.headings) o2.headings = t2.headings.map((t3) => G(t3));
  else if (e2?.tHead) o2.headings = Array.from(e2.tHead.querySelectorAll("th")).map((t3, e3) => {
    const o3 = ((t4) => {
    ...
    const r2 = s2[e3];
    return "false" !== t3.dataset.sortable?.trim().toLowerCase() && "false" !== t3.dataset.sort?.trim().toLowerCase() || (r2.sortable = false), "false" === t3.dataset.searchable?.trim().toLowerCase() && (r2.searchable = false), "true" !== t3.dataset.hidden?.trim().toLowerCase() && "true" !== t3.getAttribute("hidden")?.trim().toLowerCase() || (r2.hidden = true), ["number", "string", "html", "date", "boolean", "other"].includes(t3.dataset.type) && (r2.type = t3.dataset.type, "date" === r2.type && t3.dataset.format && (r2.format = t3.dataset.format)), o3;
  });
  else if (t2.data?.length) {
    const e3 = t2.data[0], s3 = Array.isArray(e3) ? e3 : e3.cells;
    o2.headings = s3.map((t3) => G(""));
  } else e2?.tBodies.length && (o2.headings = Array.from(e2.tBodies[0].rows[0].cells).map((t3) => G("")));
  ...
  } else e2?.tBodies?.length && (o2.data = Array.from(e2.tBodies[0].rows).map((t3) => ({ attributes: r(t3.attributes), cells: Array.from(t3.cells).map((t4, e3) => {
...
var st = { sortable: true, locale: "en", numeric: true, caseFirst: "false", searchable: true, sensitivity: "base", ignorePunctuation: true, destroyable: true, searchItemSeparator: "", searchQuerySeparator: " ", searchAnd: false, searchMethod: false, data: {}, type: "html", format: "YYYY-MM-DD", columns: [], paging: true, perPage: 10, perPageSelect: [5, 10, 15, 20, 25], nextPrev: true, firstLast: false, prevText: "‹", nextText: "›", firstText: "«", lastText: "»", ellipsisText: "…", truncatePager: true, pagerDelta: 2, scrollY: "", fixedColumns: true, fixedHeight: false, footer: false, header: true, hiddenHeader: false, caption: void 0, rowNavigation: false, rowSelectionKeys: ["Enter", " "], tabIndex: false, pagerRender: false, rowRender: false, tableRender: false, diffDomOptions: { valueDiffing: false }, labels: { placeholder: "Search...", searchTitle: "Search within table", perPage: "entries per page", pageTitle: "Page {page}", noRows: "No entries found", noResults: "No results match your search query", info: "Showing {start} to {end} of {rows} entries" }, template: (t2, e2) => `<div class='${t2.classes.top}'>
...
var at = class {
  ...
  constructor(t2, e2 = {}) {
    ...
    this.options = { ...st, ...e2, diffDomOptions: i2, labels: n2, classes: a2 }, this._initialHTML = this.options.destroyable ? s2.outerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = { onResize: () => this._onResize() }, this._dd = new F(this.options.diffDomOptions || {}), this.initialized = false, this._events = {}, this._currentPage = 0, this.onFirstPage = true, this.hasHeadings = false, this.hasRows = false, this._searchQueries = [], this.init();
  }
  init() {
